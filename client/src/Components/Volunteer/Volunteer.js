...
const Volunteer = () => {
  ...
  return (
    <div>
      <VolunteerHero bg={volunterHeroDetails.bg} title={volunterHeroDetails.title} description={volunterHeroDetails.description} buttonText={volunterHeroDetails.buttonText}/>
      <VolunteerOptions/>
      <VolunteerForm/>
    </div>
  )
